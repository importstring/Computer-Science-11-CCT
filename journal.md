...
Reflecting on how things went down. My orginal plan was to do some finishing touches and a little bit of development on the first days of the break but I ended up being really busy skiing at Mount Treblem in Montreal and spending time with family. Overall I think I adhered to the original plan decently well. From experience I know that it's always important to plan in buffers in projects just in case things go south. For me, our cielling came crashing down so we had to go all around Toronto and move around a bunch which cut into a lot of the break. Since I had given myself a huge buffer I was able to still for the most part have everything put together well in time. If I was to advise someone on how to start a project like this I would be very very passionately telling them to plan massive buffers and also be very clear about every feature and most importantly the datatypes your working with. An issue I ran into was the data types I was using. In some cases I wished I had used sets because I was dealing with a lot of duplicate problems. Sometimes I wished I used tuples for debugging. Lastly I learned so much from this project and am super proud of what I did. The biggest learning was learning how to use the VS Code debugger. Since I didn't have access to easy print statements when the curses menu was active I had to find ways around it (the vs code debugger) which forced me to be a better coder. I now am 2-4x faster when debugging and can never go back to print statements. 
